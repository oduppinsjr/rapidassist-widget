            ...
            <div class="slt-box">
                <div class="tp-header">
                    <div class="tp-header-text">
                        <img alt="Whiterail" width="200" height="41" src="images/ab-logo-v2.png">
