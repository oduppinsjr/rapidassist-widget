...
<body>
    <div class="main-widget">
            ...
            <div class="slt-box">
                <div class="tp-header">
                    <div class="tp-header-text">
                        <img style="background:white;" alt="Whiterail" width="100" height="16" src="images/logo.png">
        ...
        <div class="act-widget-box">
            <div class="act-widget-btnText"><i class="fas fa-comment-alt"></i>Text Us</div>
